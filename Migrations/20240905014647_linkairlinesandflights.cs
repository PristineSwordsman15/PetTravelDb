        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AirlinesName = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    AirlinesDescription = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookingRefNo = table.Column<string>(type: "nvarchar(6)", maxLength: 6, nullable: false),
                    DepartureTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ArrivalTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Origin = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Destination = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    PetId = table.Column<int>(type: "int", maxLength: 250, nullable: false),
                    PetName = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PetNotes = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PetFlight", x => x.PetFlightId);
                    table.ForeignKey(
                        name: "FK_PetFlight_Flights_FlightsId",
                        column: x => x.FlightsId,
                        principalTable: "Flights",
                        principalColumn: "FlightsId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PetFlight_Pet_PetID",
                        column: x => x.PetId,
                        principalTable: "Pet",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PetFlight_FlightsId",
                table: "PetFlight",
                column: "FlightsId");

            migrationBuilder.CreateIndex(
                name: "IX_PetFlight_PetID",
                table: "PetFlight",
                column: "PetId");
        }
